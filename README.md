This tool finds all the ships involved in any pvp interaction. It uses zKillboard to find kills, then verifies each one with the official EVE ESI for maximum accuracy. This process can be slow.
